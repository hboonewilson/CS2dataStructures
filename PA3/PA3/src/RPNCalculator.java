...
public class RPNCalculator {
    ...
    public double subtract() {
        ...
        return stack.push(item1 - item2);
    }
    public double multiply() { return stack.push(stack.pop() * stack.pop()); }
    ...
    public double power() {
        Double item2 = stack.pop();
        Double item1 = stack.pop();
        return stack.push(Math.pow(item1, item2));
    }

    public double exp() { return stack.push( Math.exp(stack.pop())); }

    public double log() { return stack.push(Math.log(stack.pop()));
            /* input code here; use Math.log */
             }

    public double sin() { return stack.push(Math.sin(stack.pop()));
            /* input code here; use Math.sin */}

    public double cos() { return stack.push(Math.cos(stack.pop()));
    /* input code here; use Math.cos */ }

    public double sqrt() { return stack.push(Math.sqrt(stack.pop()));
    ...
    public void clear() {
        ...
        catch (Error EmptyStackException){
            errorThrown = true;
        }

        /* input code here, hint: use while loop */
    }
